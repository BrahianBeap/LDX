...
- [x] Documentar el procedimiento completo de alta de un proyecto nuevo (perfil, contenedor gateway de servicios, límites, grupo) como parte de [06_Operacion.md](../06_Operacion.md). ✅ Ver [06_Operacion.md — Cómo incorporar un nuevo sitio al cluster](../06_Operacion.md).
